...
*   Faça o download e instale a última versão do pacote [docker-php-project_2.7.1_all.deb](https://github.com/ricardopedias/docker-php-project/raw/master/dist/docker-php-project_2.7.1_all.deb);
